...
HRESULT CGraphic_Device::Ready_Graphic_Device(WINMODE eMode, PDIRECT3DDEVICE9* ppGraphic_Device)
{
	if (nullptr != m_pSDK)
		return E_FAIL;
	...
	if (Caps.DevCaps & D3DDEVCAPS_HWTRANSFORMANDLIGHT)
		dwBehaviorFlag |= D3DCREATE_HARDWARE_VERTEXPROCESSING | D3DCREATE_MULTITHREADED;
	else
		dwBehaviorFlag |= D3DCREATE_SOFTWARE_VERTEXPROCESSING | D3DCREATE_MULTITHREADED;
	...
	*/
	...
	PresentParameter.BackBufferWidth = g_iWinCX;
	PresentParameter.BackBufferHeight = g_iWinCY;
	...
	PresentParameter.hDeviceWindow = g_hWnd;
	...
	if (FAILED(m_pSDK->CreateDevice(D3DADAPTER_DEFAULT, D3DDEVTYPE_HAL, g_hWnd, dwBehaviorFlag, &PresentParameter, &m_pGraphic_Device)))
		return E_FAIL;
