...
#pragma region 타일생성
	...
	pTerrain = CTerrain::Create(m_pGraphic_Device, TERRAIN(true), L"lv_One_stair_down", SCENE_EDITOR);
	pObjMgr->Add_Prototype(L"lv_One_stair_down", SCENE_EDITOR, pTerrain); m_vecTile.push_back(pTerrain); Safe_AddRef(pTerrain);
	pTerrain = CTerrain::Create(m_pGraphic_Device, TERRAIN(true), L"lv_One_stair_up", SCENE_EDITOR);
