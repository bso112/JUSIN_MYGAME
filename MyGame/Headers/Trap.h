...
private:
	explicit CTrap(PDIRECT3DDEVICE9 _pGraphic_Device) : CTerrain(m_pGraphic_Device) {};
...
private:
	...
	CTrap * CTrap::Create(PDIRECT3DDEVICE9 _pGraphic_Device, TERRAIN _tData, const _tchar* _pTextureTag, SCENEID _eTextureScene, _tchar* _pFilePath)
	{
